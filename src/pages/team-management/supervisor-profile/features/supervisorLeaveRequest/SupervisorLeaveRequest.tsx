...
import SupervisorNewLeaveRequest from "./SupervisorNewLeaveRequest";
import SupervisorRegularizationRequest from "./SupervisorRegularizationRequest";
import SupervisorLeaveRequstHistory from "./SupervisorLeaveRequestHistory";
import SupervisorRegularizationHistory from "./SupervisorRegularizationHistory";
  ...
  return (
    <div>
      <div className="flex flex-col gap-y-5">
        <SupervisorNewLeaveRequest />
        <SupervisorRegularizationRequest/>
      </div>
      ...
      <div className="bg-white rounded-lg">
        ...
        {isRegularizationHistoryOpen && (
          <div className="pb-4">
            <SupervisorRegularizationHistory/>
          </div>
        )}
      </div>
    </div>
