...
import telecallersTaskData from "../../../../../data/task-management/fieldAgentsTask.json";
import { FaHome } from "react-icons/fa";

const FieldTaskPage = () => {
  const { taskId } = useParams();
  console.log("I am taskIddddd ", taskId);
    ...
    <div className="mr-4">
      ...
      <div className="bg-white rounded-lg shadow border border-gray-200 p-4 flex flex-col gap-6">
        ...
        <TaskDetail
          ...
          agentInitials={currentTask.agent
            .split(" ")
            .map((n) => n[0])
            .join("")}
