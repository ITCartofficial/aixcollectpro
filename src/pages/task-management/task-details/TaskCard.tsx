      ...
      <div className="flex-1">
        ...
        <div className="border border-neutral-200 rounded-lg p-4">
          <div className="grid grid-cols-4 gap-y-5 text-sm">
            ...
            <div>
              <span className="text-neutral-500 flex ">Task Status</span>
              <Badge variant={taskDetails.taskStatus === "Pending" ? "warning" : "success"}>
                {taskDetails.taskStatus}
              </Badge>
            </div>
            <div>
              <span className="text-neutral-500">Collection Status</span>
            ...
            <div>
              <span className="text-neutral-500 mr-2">Recommended Time</span>
      ...
      <div className="flex-1">
        ...
        <div className="border border-neutral-200 rounded-lg p-4">
          <div className="grid grid-cols-5 gap-y-5 text-sm mb-9.5">
            <div>
              <span className="text-neutral-500">Loan Category</span>
            ...
            <div>
              <span className="text-neutral-500">Penal interest</span>
              <p className="font-medium">{loanInformation.penalInterest}</p>
            </div>
            <div>
              <span className="text-neutral-500">Over Due Days</span>
            ...
            <div>
              <span className="text-neutral-500">TOS</span>
