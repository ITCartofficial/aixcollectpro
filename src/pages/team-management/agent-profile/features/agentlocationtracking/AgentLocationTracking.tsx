      ...
      <div className="p-4 bg-gray-50">
        <div className="flex items-center justify-center space-x-8 text-sm">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-gray-700">Completed Check-in</span>
          </div>

          <div className="flex items-center space-x-2">
            <BiCurrentLocation className="w-4 h-4 text-primary-700" />
            <span className="text-gray-700">Agent Current Location</span>
          </div>

          <div className="flex items-center space-x-2">
            <MdLocationOn className="w-4 h-4 text-primary-700" />
            <span className="text-gray-700">Next Check-in Point</span>
          </div>
        </div>
      </div>
    </div>
