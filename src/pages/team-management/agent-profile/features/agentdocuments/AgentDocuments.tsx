...
//   agentData?: DocVerificationTask;
// }

// const AgentDocuments : React.FC<DocumentsProps> = ({ agentData }) =>  {
//     console.log("I am documents",agentData)
...
const AgentDocuments: React.FC<DocumentsProps> = ({ agentData }) => {
  ...
  const data = agentData
    ? docVerificationTask.filter((doc) => doc.uploadedBy === agentData.name)
    : docVerificationTask;
  const [selectedRows, setSelectedRows] = useState<DocVerificationTask[]>([]);
