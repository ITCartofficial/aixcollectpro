...
import { initializeUserFromStorage, logoutUser } from '../../../lib/redux/slices/userSlice';
import { initializeNotifications } from '../../../lib/redux/slices/notificationsSlice';
import { selectCurrentUser, selectIsAuthenticated } from '../../../lib/redux/selectors';
...
const Header: React.FC = () => {
  ...
  // Initialize user and notifications from localStorage on component mount
  useEffect(() => {
  ...
  useEffect(() => {
    if (currentUser) {
      dispatch(initializeNotifications(currentUser));
    }
