...
const AgentProfile: React.FC<UserProfileProps> = ({
  ...
  return (
    <div className="p-4 w-full">
      ...
      <div className="w-full flex  justify-between items-start md:items-center gap-4 mb-6">
        <div>
          ...
          <div className="flex items-center gap-y-2">
            ...
            <p>\Team Management \Rakesh Kumar</p>
          </div>
        </div>
      ...
      <div className="mx-auto shadow-2xl border-gray-600 rounded-lg  overflow-hidden">
        {/* Header Section */}
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative">
                <Avatar name={name} image="" size="xl" bgColor="#039FAA" />
              </div>
