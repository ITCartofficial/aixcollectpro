...
interface FieldAgent {
  ...
  location: string;
  status: "online" | "On Road" | "In Active" | "On Leave"|string;
  lastSynced: string;
  avatar?: string;
  email: string;
  role: string;
...
const AgentProfile: React.FC<UserProfileProps> = () => {
  ...
  // // Find the agent data from fieldAgentData.json using agentId
  const agentData: FieldAgent | undefined = fieldAgentData.find(
    (agent: FieldAgent) => agent.agentId === agentId
  );
    ...
    return (
      <div className="p-4 w-full">
        <div className="text-center py-8">
          ...
          <p className="text-gray-500">No agent found with ID: {agentId}</p>
        </div>
      </div>
    );
  }
    ...
    <div className="p-4 w-full">
      ...
      <div className="w-full flex justify-between items-start md:items-center gap-4 mb-6">
        <div>
          ...
          <div className="flex items-center gap-y-2">
            <FaHome className="w-4 h-4 text-neutral-500" />
            <p>\Team Management \{agentData.name}</p>
          </div>
        </div>
        <div className="flex items-center gap-3 sm:gap-4">
          <DateRangePickerInput />
                ...
                <span
                  ...
                  style={{
                    backgroundColor:
                      ...
                      agentData.status === "On Road"
                        ? "#0C9D61"
                        : agentData.status === "In Active"
                        ? "#F59E0B"
                        : "#EF4444",
                  }}
                >
                  {agentData.status === "online" ? "Online" : agentData.status}
                </span>
                <span className="text-xs text-gray-700 px-3 py-1 bg-gray-200 border border-gray-300 rounded-full">
                  Last Synced: {agentData.lastSynced}
                </span>
              </div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 flex-1">
              ...
              <div>
                ...
                <p className="text-gray-900 font-medium">{agentData.role}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-900 font-medium">{agentData.agentId}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-900 font-medium">{agentData.Vendor}</p>
              </div>
