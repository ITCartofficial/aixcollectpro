  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-lg mt-3">
        <div
          className="flex items-center justify-between cursor-pointer px-3 py-3 hover:bg-neutral-50 transition-colors mb-2 rounded-sm"
          onClick={toggleLeaveHistory}
        >
          <h2 className="text-regular font-semibold text-neutral-700">
            Leave Request History
          </h2>
          <button className="text-neutral-500 hover:text-neutral-700 transition-colors cursor-pointer">
            {isLeaveHistoryOpen ? (
