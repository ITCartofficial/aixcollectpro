  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#CACACA]/80">
      <div className="relative bg-white rounded-[12px] shadow-xl flex flex-col items-center w-[600px] min-h-[350px] px-8 py-10">
        ...
        <p className="text-gray-600 text-center mb-8 text-base px-2 leading-6">
        ...
        <input
          ...
          value={email}
          readOnly
          className="w-full max-w-xl px-4 py-4 border border-[#CACACA] rounded-lg bg-white text-base font-normal mb-8 focus:outline-none"
          placeholder="Email"
        />
        {/* Continue Button */}
        <PrimaryButton
          text="Continue"
          onClick={onContinue}
          className="w-full max-w-xl py-3 px-4 rounded-lg text-base font-semibold bg-[#0064E1] hover:bg-[#0055C4] transition text-white"
        />
      </div>
    </div>
  );
