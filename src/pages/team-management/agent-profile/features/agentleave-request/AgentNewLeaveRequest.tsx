...
const AgentNewLeaveRequest: React.FC = () => {
    ...
    return (
        <div className="bg-white rounded-lg">
            <h2 className="text-regular font-semibold text-neutral-700 pb-4">New Leave Request</h2>
...
export default AgentNewLeaveRequest;