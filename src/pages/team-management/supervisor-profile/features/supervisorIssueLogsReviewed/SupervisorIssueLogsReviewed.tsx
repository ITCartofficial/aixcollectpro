...
import telecallerIssuesData from "../../../../../../data/telecaller-profile/telecallerIssuesData.json";
...
const SupervisorIssueLogsReviewed = () => {
  const issuesData: AgentIssueData[] = telecallerIssuesData as AgentIssueData[];
...
export default SupervisorIssueLogsReviewed;
